...
public class TransTerrestre implements Transporte {

    private Paquete paquete;

    @Override
    public void enviarPaquete() {
        System.out.println("Enviando paquete por transporte terrescre con destino " + paquete.getDestino());
    }
    ...
    public TransTerrestre(Paquete paqueteParams) {
